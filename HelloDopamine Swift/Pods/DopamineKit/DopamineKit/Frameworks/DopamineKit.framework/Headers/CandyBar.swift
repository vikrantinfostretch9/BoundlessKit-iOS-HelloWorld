...
public enum Candy{
    case Other, Certificate, Crown, Crown2, MedalStar, RibbonStar, Stars, Stopwatch, ThumbsUp, TrophyHand, TrophyStar, WreathStar
...
public class CandyBar: Banner {
    ...
    /// A CandyBar with the provided `title`, `subtitle`, and optional preset icon, ready to be presented with `show()`.
    ///
    /// - parameter title: The title of the banner. Optional. Defaults to nil.
    /// - parameter subtitle: The subtitle of the banner. Optional. Defaults to nil.
    /// - parameter icon: The icon on the left of the banner.
    /// - parameter backgroundColor: The color of the banner's background view. Defaults to `UIColor.blackColor()`.
    /// - parameter didTapBlock: An action to be called when the user taps on the banner. Optional. Defaults to `nil`.
    public required init(title: String? = nil, subtitle: String? = nil, icon: Candy, backgroundColor: UIColor = UIColor.blackColor(), didTapBlock: (() -> ())? = nil) {
