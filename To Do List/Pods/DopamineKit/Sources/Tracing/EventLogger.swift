...
public class EventLogger : NSObject {
    ...
    @objc public static let EVENT_TYPE_APP_FOCUS: NSString = "appFocus"
    @objc public static let EVENT_TYPE_VIEW_CONTROLLER: NSString = "viewController"
    
    @objc public static func logEvent(withType event: String, withTag tag: String) {
//        DopamineKit.debugLog("Got event:\(event) with tag:\(tag)")
    ...
    @objc public static func logEvent(withUIViewController viewController: UIViewController, withTag tag: String) {
